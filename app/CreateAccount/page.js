...
const Page = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="h-[50vh] w-screen flex bg-white">
        ...
        <div className="w-[70vw] h-[91vh] rounded-l-[100px] bg-[#faf8f0] flex flex-col justify-center items-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            ...
            <button
              type="submit"
              className="bg-[#ffdd00] w-[400px] mx-auto h-12 rounded-full text-xl font-medium hover:scale-110 hover:ease-out duration-300 mt-6"
            >
              Save
            </button>
          </form>
