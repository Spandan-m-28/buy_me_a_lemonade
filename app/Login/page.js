...
const Login = () => {
  return (
    <div>
      <Navbar />
      <div className="w-full flex items-center justify-center h-[91vh] mx-auto">
        <div className="w-[50%] h-[40%] rounded-3xl flex flex-col items-center">
          <div className="text-3xl font-medium mb-11">LogIn / SignUp with</div>
